...
$('exportarCronogramaContratista')?.addEventListener('click',()=>{
  ...
  function iniciarMapaFichaCusco(){
    ...
    if(!mapaFichaCusco){
      mapaFichaCusco=L.map(contenedor,{zoomControl:false,attributionControl:true}).setView([-13.53195,-71.96746],13);
